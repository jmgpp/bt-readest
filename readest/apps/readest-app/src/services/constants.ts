...
export const LOCAL_BOOKS_SUBDIR = 'BookTalk/Books';
export const CLOUD_BOOKS_SUBDIR = 'BookTalk/Books';
...
export const DOWNLOAD_READEST_URL = 'https://booktalk.com?utm_source=booktalk_web';

export const READEST_WEB_BASE_URL = 'https://web.booktalk.com';
