...
const BookMenu: React.FC<BookMenuProps> = ({ menuClassName, setIsDropdownOpen }) => {
  ...
  const showAboutBookTalk = () => {
    setAboutDialogVisible(true);
    setIsDropdownOpen?.(false);
  };
  const downloadBookTalk = () => {
  ...
  return (
    ...
    >
      ...
      {isWebApp && <MenuItem label={_('Download BookTalk')} noIcon onClick={downloadBookTalk} />}
      <MenuItem label={_('About BookTalk')} noIcon onClick={showAboutBookTalk} />
    </div>
  );
};
